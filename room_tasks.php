...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $create_task = $conn->prepare("INSERT INTO tasks (room_id, task_name, task_description, due_date, task_file) VALUES (?, ?, ?, ?, ?)");
    $create_task->bind_param("issss", $room_id, $task_name, $task_description, $due_date, $task_file);
...
<body>
  ...
  <main>
    <form action="room_tasks.php?id=<?php echo $room_id; ?>" method="POST" enctype="multipart/form-data">
      ...
      <button class="back-to-dashboard-btn" onclick="window.location.href='dashboard.php';">
    Back to Dashboard
</button>
